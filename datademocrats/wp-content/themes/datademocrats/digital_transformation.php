    ...
    <div class="row g-5">
        ...
        <div class="col-lg-4">
            <div class="row g-5">
                <?php
                $args = array(
                    'post_type'      => 'architecture_digital',
                    'posts_per_page' => -1,
                    'orderby'        => 'menu_order',
                    'order'          => 'ASC'
                );
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <?php 
                    $businesses_digital = new WP_Query(array(
                        'post_type'      => 'businesses_digital',
                        'posts_per_page' => -1,
                        'orderby'        => 'date',
                        'order'          => 'ASC'
                    ));
                    if ($businesses_digital->have_posts()) :
                        while ($businesses_digital->have_posts()) : $businesses_digital->the_post(); ?>
