...
<div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="display-4 text-white animated slideInDown pt-5 mb-4">Digital Transformation</h1>
        <nav aria-label="breadcrumb animated slideInDown">
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                <li class="breadcrumb-item text-light active" aria-current="page">Digital Transformation</li>
            </ol>
        </nav>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="text-primary mb-3">Industry 4.0 Digital Transformation</h2>
                <p class="text-muted">
                    At Data Democrats, we empower businesses to embrace the future of Industry 4.0 by integrating
                    smart connectivity, automation, and AI-driven insights into every layer of operations.
                    Our solutions enable enterprises to achieve higher efficiency, flexibility, and resilience 
                    in a rapidly evolving digital landscape.
                </p>
                <p class="text-muted">
                    From IoT-enabled systems and predictive maintenance to cyber-physical integration and 
                    real-time data intelligence, we deliver end-to-end transformation strategies. With a strong 
                    focus on scalability, sustainability, and innovation, we help organizations unlock the full 
                    potential of Industry 4.0 for smarter, data-driven manufacturing and industrial growth.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="h-100">
                    <h1 class="display-6 mb-5">Revolutionizing Industries with Industry 4.0</h1>
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0">Automation & Robotics</h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0">AI-Driven Insights</h5>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <h5 class="mb-0">Cyber-Physical Systems</h5>
                            </div>
                        </div>
                    </div>
                    <p class="mb-4">
                        Data Democrats’ Industry 4.0 solutions empower manufacturing and enterprises to embrace
                        digital transformation. By integrating IoT, AI, automation, and advanced analytics, we help
                        organizations improve efficiency, enable predictive maintenance, and achieve sustainable growth
                        in a competitive landscape.
                    </p>
                    <div class="mt-4 pt-2 border-top">
                        <p class="fw-semibold mb-0">
                            Vision: Drive industrial innovation by creating smarter, connected, and future-ready
                            ecosystems powered by Industry 4.0.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="container py-5">
        ...
        <div class="col-lg-4">
            <div class="row g-5">
                <div class="col-12 wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <p class="mb-0">Enable real-time communication between machines, devices, and systems.</p>
                </div>
                <div class="col-12 wow zoomIn" data-wow-delay="0.6s">
                    ...
                    <p class="mb-0">Streamline production lines with intelligent robotics and autonomous systems.</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-4 wow zoomIn" data-wow-delay="0.9s" style="min-height: 350px;">
            <div class="position-relative h-100">
                <img class="position-absolute w-100 h-100 rounded" data-wow-delay="0.1s"
                    src="<?php bloginfo('template_directory'); ?>/img/index/Digital Transformation.png"
                    alt="Industry 4.0 Digital Transformation" 
        ...
        <div class="col-lg-4">
            <div class="row g-5">
                <div class="col-12 wow zoomIn" data-wow-delay="0.4s">
                    ...
                    <p class="mb-0">Use AI and analytics to optimize operations and predict future trends.</p>
                </div>
                <div class="col-12 wow zoomIn" data-wow-delay="0.8s">
                    ...
                    <p class="mb-0">Integrate digital systems with physical processes for smarter manufacturing.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-5 mt-4">
        <div class="col-lg-4 wow zoomIn" data-wow-delay="0.2s">
            ...
            <p class="mb-0">Reduce downtime with AI-powered monitoring and predictive equipment servicing.</p>
        </div>
        <div class="col-lg-4 wow zoomIn" data-wow-delay="0.4s">
            ...
            <h4>IoT & Cloud Integration</h4>
            <p class="mb-0">Leverage IoT sensors and cloud platforms for scalable, connected operations.</p>
        </div>
        <div class="col-lg-4 wow zoomIn" data-wow-delay="0.6s">
            ...
            <p class="mb-0">Adopt eco-friendly practices with energy-efficient and smart resource management.</p>
        </div>
    </div>
</div>
