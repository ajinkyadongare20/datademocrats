...
<div class="container-fluid page-header py-5 wow fadeIn" data-wow-delay="0.1s">
    <div class="container text-center py-5">
        <h1 class="display-4 text-white animated slideInDown m-5">
            <?php echo esc_html(get_field('technology_solutions_breadcrumb_page')); ?>
        </h1>
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-4">
            <div class="row g-5">
                <?php
                $args = array(
                    'post_type'      => 'architecture_data_an',
                    'posts_per_page' => -1,
                    'orderby'        => 'menu_order',
                    'order'          => 'ASC'
                );
        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <?php 
                    $businesses_data_anal = new WP_Query(array(
                        'post_type'      => 'businesses_data_anal',
                        'posts_per_page' => -1,
                        'orderby'        => 'date',
                        'order'          => 'ASC'
                    ));
                    if ($businesses_data_anal->have_posts()) :
                        while ($businesses_data_anal->have_posts()) : $businesses_data_anal->the_post(); ?>
