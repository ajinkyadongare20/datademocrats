        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <?php 
                    $businesses_cyber = new WP_Query(array(
                        'post_type'      => 'businesses_cyber',
                        'posts_per_page' => -1,
                        'orderby'        => 'date',
                        'order'          => 'ASC'
                    ));
                    if ($businesses_cyber->have_posts()) :
                        while ($businesses_cyber->have_posts()) : $businesses_cyber->the_post(); ?>
