        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <?php 
                    $business_data_center = new WP_Query(array(
                        'post_type'      => 'business_data_center',
                        'posts_per_page' => -1,
                        'orderby'        => 'date',
                        'order'          => 'ASC'
                    ));
                    if ($business_data_center->have_posts()) :
                        while ($business_data_center->have_posts()) : $business_data_center->the_post(); ?>
