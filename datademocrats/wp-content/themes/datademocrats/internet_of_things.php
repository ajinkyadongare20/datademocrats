        ...
        <div class="row g-5">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="row gy-5 gx-4">
                    ...
                    <?php 
                    $businesses_iot = new WP_Query(array(
                        'post_type'      => 'businesses_iot',
                        'posts_per_page' => -1,
                        'orderby'        => 'date',
                        'order'          => 'ASC'
                    ));
                    if ($businesses_iot->have_posts()) :
                        while ($businesses_iot->have_posts()) : $businesses_iot->the_post(); ?>
